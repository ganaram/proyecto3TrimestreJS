...
function editForm() {
  ...
  var asignatura = $('#formTest').attr("data-asignatura");
  $('#successForm').modal('toggle');
  axios.put("/editarAjax/".concat(asignatura), datos).then(function (response) {
...
module.exports = __webpack_require__(/*! /home/usuario/Sites/pccompuestosJS/resources/js/edit.js */"./resources/js/edit.js");
